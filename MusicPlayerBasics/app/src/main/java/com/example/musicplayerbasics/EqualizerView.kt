...
class EqualizerView(
    ...
    private val sharedPreferences: SharedPreferences by lazy {
        context.getSharedPreferences("EqualizerViewPrefs", Context.MODE_PRIVATE)
    }
    ...
    private fun initBands(bandsLinearLayout: LinearLayoutCompat) {
        ...
        for (i in 0 until numberFrequencyBands) {
            ...
            val seekBar: VerticalSeekBar = bandItemView.findViewById(R.id.item_band_sb_progress)
            seekBar.maxValue = upperEqualizerBandLevelMilliBel - lowerEqualizerBandLevelMilliBel
            ...
            val progress = sharedPreferences.getInt("SeekBar_${equalizerBandIndex.toInt()}", 0)
            ...
            seekBar.setOnProgressChangeListener { progress ->
                ...
                sharedPreferences.edit().putInt("SeekBar_${equalizerBandIndex.toInt()}", progress).apply()
            }
    ...
    private fun initSwitch(view: View) {
        ...
        equalizer.enabled = sharedPreferences.getBoolean("SwitchState", false)
    ...
    private fun initPresets(presetsLinearLayout: LinearLayoutCompat) {
        ...
        val savedPresetIndex = sharedPreferences.getInt("SelectedPreset", -1)
        ...
        for (i in 0 until presetsCount) {
            ...
            checkIcon.visibility = if (currentPreset == preset || i == savedPresetIndex) {
            ...
            view.setOnClickListener {
                ...
                /* Save the selected preset index */
                sharedPreferences.edit().putInt("SelectedPreset", i).apply()
