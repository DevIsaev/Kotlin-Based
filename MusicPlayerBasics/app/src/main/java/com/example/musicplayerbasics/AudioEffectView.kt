...
class AudioEffectView(private val fragmentManager: FragmentManager, private val context: Context, private val parent: ViewGroup?, private val audioEffectManager: AudioEffectManager, ){
