...
class ColorSpinner(context:Context,  list:List<ColorsObject>) :ArrayAdapter<ColorsObject>(context,0,list) {
    ...
    {
        val colorObject : ColorsObject = getItem(position) ?: return view
